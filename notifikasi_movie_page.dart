  ...
  Widget message(int index) {
    ...
    return Container(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
        Text('Massage',style: primaryTextStyle.copyWith(fontSize: textSize,fontWeight: FontWeight.w400),),

        Text('Massage Direction',style: primaryTextStyle.copyWith(fontSize: textSize,fontWeight: FontWeight.w400),),
      ],)
    );
  }
